...
export default function RootLayout({children}:{children:ReactNode}){
  return <html lang="en"><body><header className="siteHeader"><div className="topline">LUNA CRUENTA — THE BLOOD MOON ARCHIVE</div><div className="navWrap"><Link href="/" className="brand" aria-label="Luna Cruenta home"><span className="logoWrap"><Image src="https://cdn.shopify.com/s/files/1/1009/1325/0631/files/luna-cruenta-lc-logo.png?v=1789377736" alt="Luna Cruenta LC logo" width={38} height={38} priority/></span><span>LUNA CRUENTA</span></Link><nav className="desktopNav"><Link href="/shop">Shop</Link><Link href="/drops">Drops</Link><Link href="/calendar">Calendar</Link><Link href="/archive">Archive</Link><Link href="/membership">Bloodline</Link><Link href="/about">About</Link></nav><div className="accountLinks"><Link href="/vault">Vault</Link><Link href="/account">Account</Link></div><MobileMenu/></div></header><main>{children}</main><footer className="footer"><div><strong>LUNA CRUENTA</strong><p>Small numbered chapters. Same blood moon.</p><a className="footerEmail" href="mailto:info@lunacruenta.com">info@lunacruenta.com</a></div><div className="footerLinks"><Link href="/drops">Drops</Link><Link href="/membership">Bloodline</Link><Link href="/archive">Archive</Link></div><div className="footerMeta"><span>© 2026 L.C.</span><span>Built for the first chapter.</span></div></footer></body></html>;
}
